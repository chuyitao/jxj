...
import {addHealthAssessment, listHealthAssessment,} from '@/api/nursing/healthAssessment';
...
// 上传请求路径
const pdfUrlAction = ref(import.meta.env.VITE_APP_BASE_API+'/nursing/healthAssessment/upload');
const headers = {
